...
function initializeComponents(dataArray){
    //skapar alla stored cards och lägger dem i todo-arean
...
function appendComponents(card){
    ...
    let htmlString = `
        <div id=${card.id.toString()} class="kanbanCard ${card.position}" draggable="true">
            ...
            <div class="deadline">
                <button class="deadline_button">
                    <a href="deadline.html">Deadline</a>
                </button>
            </div>
            <div class="bilder">
                <button class="bilder_button">
                    <a href="slider.html">Bilder för Task</a>
                </button>
            </div>
